...
public class UserService {
	...
	public UserService(UserRepository userRepository, PasswordEncoder passwordEncoder,
			AuthorityRepository authorityRepository, UserSkillsService userSkillsService) {
	...
	public List<User> getAllRegularUsers() {
		...
		return users.stream().filter(p -> !getAuthorityAsString(p.getAuthorities()).contains(AuthoritiesConstants.ADMIN))
